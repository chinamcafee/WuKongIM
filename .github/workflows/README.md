...
| `linku-v3-ci.yml` | `Safety Automation - Link-U v3 CI` | Runs explicit-root Go, Link-U contract, Manager Web, Demo, and repeated real-disk gates |
| `docker.yml` | `Safety Automation - Publish Docker Images` | Publishes reviewed release images to the configured registries |
| `go-ossf-slsa3-publish.yml` | `Safety Automation - Publish SLSA Go Release` | Builds release binaries with SLSA provenance and verifies the published artifacts |
