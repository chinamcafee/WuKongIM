...
var schemaFields = []fieldSpec{
	...
	{TOMLPath: "gateway.token_auth_enabled", EnvKey: "WK_GATEWAY_TOKEN_AUTH_ENABLED", Kind: kindBool, Group: "gateway", Label: "Gateway token authentication enabled", Description: "Requires WKProto CONNECT tokens to match durable uid and device metadata. Keep enabled outside explicit test environments."},
	{TOMLPath: "gateway.token_auth_timeout", EnvKey: "WK_GATEWAY_TOKEN_AUTH_TIMEOUT", Kind: kindDuration, Group: "gateway", Label: "Gateway token authentication timeout", Description: "Maximum duration for the routed device-token metadata lookup during one CONNECT authentication attempt."},
	...
	{TOMLPath: "webhook.outbox_max_entries", EnvKey: "WK_WEBHOOK_OUTBOX_MAX_ENTRIES", Kind: kindInt, Group: "webhook", Label: "Webhook outbox max entries"},
	{TOMLPath: "webhook.outbox_max_bytes", EnvKey: "WK_WEBHOOK_OUTBOX_MAX_BYTES", Kind: kindUint64, Group: "webhook", Label: "Webhook outbox max bytes"},
	{TOMLPath: "webhook.outbox_dispatch_batch_size", EnvKey: "WK_WEBHOOK_OUTBOX_DISPATCH_BATCH_SIZE", Kind: kindInt, Group: "webhook", Label: "Webhook outbox dispatch batch size"},
	{TOMLPath: "webhook.outbox_retry_base_delay", EnvKey: "WK_WEBHOOK_OUTBOX_RETRY_BASE_DELAY", Kind: kindDuration, Group: "webhook", Label: "Webhook outbox retry base delay"},
	{TOMLPath: "webhook.outbox_retry_max_delay", EnvKey: "WK_WEBHOOK_OUTBOX_RETRY_MAX_DELAY", Kind: kindDuration, Group: "webhook", Label: "Webhook outbox retry max delay"},
	{TOMLPath: "webhook.outbox_delivered_retention", EnvKey: "WK_WEBHOOK_OUTBOX_DELIVERED_RETENTION", Kind: kindDuration, Group: "webhook", Label: "Webhook delivered dedupe retention"},
...
func supportedConfigKeysForBuilder() []string {
	return []string{
		...
		"WK_GATEWAY_TOKEN_AUTH_ENABLED",
		"WK_GATEWAY_TOKEN_AUTH_TIMEOUT",
		...
		"WK_WEBHOOK_OUTBOX_MAX_ENTRIES",
		"WK_WEBHOOK_OUTBOX_MAX_BYTES",
		"WK_WEBHOOK_OUTBOX_DISPATCH_BATCH_SIZE",
		"WK_WEBHOOK_OUTBOX_RETRY_BASE_DELAY",
		"WK_WEBHOOK_OUTBOX_RETRY_MAX_DELAY",
		"WK_WEBHOOK_OUTBOX_DELIVERED_RETENTION",
		"WK_PLUGIN_ENABLE",
		"WK_PLUGIN_DIR",
