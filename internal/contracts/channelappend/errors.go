...
var (
	...
	// ErrIdempotencyConflict reports reuse of a durable client message number with different content.
	ErrIdempotencyConflict = errors.New("internal/message: idempotency conflict")
)
