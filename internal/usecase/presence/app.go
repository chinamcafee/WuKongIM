...
func (a *App) ownerRoute(cmd ActivateCommand) (OwnerRoute, error) {
	...
	return OwnerRoute{
		...
		CredentialVersion: cmd.CredentialVersion,
		LoginSessionID:    cmd.LoginSessionID,
		ExpiresAtUnixMS:   cmd.ExpiresAtUnixMS,
...
func routeFromOwnerRoute(conn OwnerRoute) Route {
	return Route{
		...
		LoginSessionID:    conn.LoginSessionID,
		ExpiresAtUnixMS:   conn.ExpiresAtUnixMS,
