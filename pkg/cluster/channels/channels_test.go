...
func TestCodecEncodesAllFramesWithBinaryPayload(t *testing.T) {
	...
	sampleRecord := ch.Record{ID: 10, Index: 11, Epoch: 12, Setting: 2, Topic: "record-topic", Expire: 60, RedDot: true, FromUID: "u1", ClientMsgNo: "record-client", Payload: []byte("record-payload"), SizeBytes: 14, ServerTimestampMS: 1700000000123}
